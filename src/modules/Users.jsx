  ...
  renderUserRow = (user) => {
    return (
      <TableRow key={ user.id }
                style={ {backgroundColor: user.isbanned === "1" || user.reports > 0 ? theme.palette.error[ 100 ] : null} }>
        <TableCell>
          { user.id }
        </TableCell>
        <TableCell>
        ...
        <TableCell numeric>
          ...
          <Button color="primary"
                  onClick={ () => user.isbanned === '1' ? this.openUnbanModal(user) : this.openBanModal(user) }>
